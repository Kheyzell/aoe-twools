...
export type CalculatedStats = {
    ...
    totalDamageDealtPerHit1: number,
    totalDamageDealtPerHit2: number,
    mainDamagePerSecond1: number,
    mainDamagePerSecond2: number,
    mainDamagePerSecondWithAccuracyHigh1: number,
    mainDamagePerSecondWithAccuracyHigh2: number,
    mainDamagePerSecondWithAccuracyLow1: number,
    mainDamagePerSecondWithAccuracyLow2: number,
    secondaryDamagePerSecond1: number,
    secondaryDamagePerSecond2: number,
    secondaryDamagePerSecondWithAccuracyHigh1: number,
    secondaryDamagePerSecondWithAccuracyHigh2: number,
    secondaryDamagePerSecondWithAccuracyLow1: number,
    secondaryDamagePerSecondWithAccuracyLow2: number,
